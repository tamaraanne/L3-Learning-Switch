          ...
          if a.protosrc != 0:
            ...
            if a.opcode == arp.REQUEST:
              ...
              if a.protodst in self.arpTable[dpid]:
                ...
                if self.arpTable[dpid][a.protodst] or self.fakeways:
              ...
              if a.protodst in self.routing[dpid] and n[2] != l[2] and inport != 1:
                flag = 1
                msg = of.ofp_packet_out()
                msg.data = event.ofp
...
def launch (fakeways="10.0.1.1, 10.0.2.1", arp_for_unknowns=None):
